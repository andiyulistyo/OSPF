...
import static com.blits.ospf.ospf.app.adapter.InputDetailRouterAdapter.*;
...
public class Ospf extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.buttonOSPFInterface);
    ...
    public void onClick(View view) {
        ...
        String bandwidth = bandwithMap.get(selectedItemPosition);
        @SuppressWarnings("ConstantConditions") String nameRouter = spinnerRouter.getSelectedItem().toString();

        boolean checkBoxFA0, checkBoxFA1, checkBoxSE0, checkBoxSE1;

        checkBoxFA0 = checboxFA0[selectedItemPosition];
        checkBoxFA1 = checboxFA1[selectedItemPosition];
        checkBoxSE0 = checboxSE0[selectedItemPosition];
        checkBoxSE1 = checboxSE1[selectedItemPosition];
        ...
        if (checkBoxFA0) {
            routerFA0 = "terhubung dengan router <b>"
                    + spinnerFA0Selected.get(selectedItemPosition)+"" +
                    "<br></b> IP     : "+ipFA0+"" +
                    "<br> Subnet : "+subnetFA0;
        ...
        if (checkBoxFA1) {
            routerFA1 = "terhubung dengan router "
                    + spinnerFA1Selected.get(selectedItemPosition)+"" +
                    "<br> IP     : "+ipFA1+"" +
                    "<br> Subnet : "+subnetFA1;
        ...
        if (checkBoxSE0) {
            routerSE0 = "terhubung dengan router "
                    + spinnerSE0Selected.get(selectedItemPosition)+"" +
                    "<br> IP     : "+ipSE0+"" +
                    "<br> Subnet : "+subnetSE0;
        ...
        if (checkBoxSE1) {
            routerSE1 = "terhubung dengan router "
                    + spinnerSE1Selected.get(selectedItemPosition)+"" +
                    "<br> IP     : "+ipSE1+"" +
                    "<br> Subnet : "+subnetSE1;
